...
class DataLoader(torch.utils.data.DataLoader):
    ...
    def __init__(self, dataset, batch_size=1, shuffle=False, follow_batch=[], edge_batch=False, **kwargs):
        super(DataLoader,
              self).__init__(dataset, batch_size, shuffle, collate_fn=Collater(follow_batch, edge_batch), **kwargs)
