...
if __name__ == "__main__":
    ...
    for epoch in range(500):
        ...
        if save_train:
            torch.save(checkpoint_1, os.path.join(model_dir, target[tar_idx] + '_mae_checkpoint_train.pt'))

        if save_test:
            torch.save(checkpoint_2, os.path.join(model_dir, target[tar_idx] + '_mae_checkpoint_test.pt'))
