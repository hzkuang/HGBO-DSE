...
class TPESampler(BaseSampler):
    ...
    Args:
        ...
        init_method:
            If this is `None`, using RandomSampler to initialize, otherwise using LatinHypercubeSampler.
        init_params:
            If init_method == `lhs`, this should be a dict.
        multivariate:
    ...
    def __init__(
        ...
        init_method=None,  # lhs initialization
        init_params=None,  # params sampled by lhs
        *,
        ...
        self._lhs_sampler = LatinHypercubeSampler(init_params=init_params, seed=seed)
    ...
    def sample_independent(
        ...
        if n < self._n_startup_trials:
            if self._init_method == 'lhs':
                return self._lhs_sampler.sample_independent(
    ...
    def hyperopt_parameters() -> Dict[str, Any]:
        """Return the default parameters of hyperopt (v0.1.2).
