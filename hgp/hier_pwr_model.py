...
if __name__ == "__main__":
    ...
    for epoch in range(500):
        ...
        if save_train:
            torch.save(checkpoint_1, os.path.join(model_dir, target[tar_idx] + '_mean_h64_d0_checkpoint_train.pt'))

        if save_test:
            torch.save(checkpoint_2, os.path.join(model_dir, target[tar_idx] + '_mean_h64_d0_checkpoint_test.pt'))
